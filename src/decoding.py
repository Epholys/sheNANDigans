...
class DecodedCircuit(Circuit):
    ...
    def order_inputs(self):
        ...
        for unordered_input in self.unordered_inputs:
            self.connect_input(unordered_input.input_index, unordered_input.component_key, unordered_input.component_input)
    ...
    def decode_inputs(self, idx_component  : CircuitKey , component : Circuit):
        for component_in_idx in range(0, len(component.inputs)):
            ...
            if provenance == 0:
                ...
                self.circuit.stash_input(_UnorderedInput(circuit_in_idx, idx_component, component_in_idx))
            else:
